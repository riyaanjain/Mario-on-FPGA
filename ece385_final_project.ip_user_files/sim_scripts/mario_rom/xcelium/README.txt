...
#
# Generated by export_simulation on Tue Nov 21 19:34:45 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './mario_rom.sh' script.

./mario_rom.sh -reset_run
...
./mario_rom.sh -noclean_files

For more information on the script, please type './mario_rom.sh -help'.
