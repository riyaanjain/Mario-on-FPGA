...
HD_PWD='C:/Users/arush/ece385_final_project/ece385_final_project.runs/mario_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mario_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mario_rom.tcl
